...
mod tests {
    ...
    fn read() {
        ...
        assert_eq!(_B, reader.next().unwrap().unwrap());
        assert_eq!(_A, reader.next().unwrap().unwrap());
        assert_eq!(_EXCL, reader.next().unwrap().unwrap());
        assert_eq!(_STAR, reader.next().unwrap().unwrap());
